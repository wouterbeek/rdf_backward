...
* Installation
  ...
  2. Install [[https://github.com/wouterbeek/prolog_rdf][prolog_rdf]] and its dependencies.

  3. Add the following lines to your ~.swiplrc~ file:
...
Prior to use, the following module must be imported:
